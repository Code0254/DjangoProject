...
from .forms import UserRegisterForm  # Imports the form with an email


# Create your views here.
def register (request):
    if request.method == 'POST':  # Form is submitted as a post request
        form = UserRegisterForm(request.POST)  # Create a new form that has the data in the post. 'Username and two password fields'
